        ...
        >
          <div className="mb-1 flex items-center gap-2">
            ...
            <span className="truncate opacity-60">
              Key: {diff.key.substring(0, 12)}...
            </span>
          </div>

          <div className="grid grid-cols-[1fr,20px,1fr] items-center gap-2 overflow-x-auto p-1">
            <div className="truncate rounded bg-red-500/5 p-1 text-red-700/70">
              {diff.oldValue || "∅"}
            </div>
            <ArrowRight className="h-3 w-3 text-muted-foreground" />
            <div className="truncate rounded bg-green-500/5 p-1 text-green-700">
              {diff.newValue || "∅"}
            </div>
          </div>
        </div>
